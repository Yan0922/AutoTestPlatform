...
if __name__ == "__main__":
    ...
    TEST_DIR = "/nasStore/002-ASR-DataSets/099-TestData/Model_test_data_k2"
    MODEL_DIR = os.path.join(PRO_DPATH,'model')
    # 30分钟的数据集
    TEST_DATA_DIR = os.path.join(TEST_DIR,'30_mins_dataset')

    # 定义多组参数 - 支持两种格式
    result_dir = os.path.join(TEST_RESULT_DATA_DIR, '0520_zh-en_base_test') # 测试结果保存目录
    ...
    param_list = [
        ...
        # ... 其他参数组合
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_30, result_dir,lang_list),
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_Sota1, result_dir,lang_list),
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_Sota2,result_dir,lang_list),
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_CV15,result_dir,lang_list),
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_gf,result_dir,lang_list),
        # (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_outside_dataset ,result_dir,lang_list),
        (os.path.join(MODEL_DIR, '0520'), TEST_DATA_DIR_outside_dataset ,result_dir,lang_list),
    ]
